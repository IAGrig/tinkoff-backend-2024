...
public class Links extends TableImpl<LinksRecord> {
    ...
    /**
     * The column <code>LINKS.DOMAIN_NAME</code>.
     */
    public final TableField<LinksRecord, String> DOMAIN_NAME = createField(DSL.name("domain_name"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>LINKS.REGISTERED</code>.
     */
    public final TableField<LinksRecord, OffsetDateTime> REGISTERED = createField(DSL.name("registered"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("LOCALTIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super Integer, ? super String, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super OffsetDateTime, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function6<? super Integer, ? super String, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super OffsetDateTime, ? extends U> from) {
